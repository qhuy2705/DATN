    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Legacy public assistant compatibility namespace; prefer /api/public/assistant.
                        ...
                        .requestMatchers("/api/admin/audit-logs", "/api/admin/audit-logs/**").hasRole("SYSTEM_ADMIN")
                        .requestMatchers("/api/admin/rate-limit-rules", "/api/admin/rate-limit-rules/**").hasRole("SYSTEM_ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/admin/doctors/options").hasAnyRole("SYSTEM_ADMIN", "OPERATIONS_ADMIN", "STAFF")

                        .requestMatchers("/api/cashier/**").hasRole("CASHIER")
                        .requestMatchers(HttpMethod.GET, "/api/service-desk/results/*/pdf").hasRole("SERVICE_TECHNICIAN")
                        .requestMatchers("/api/service-desk/**").hasRole("SERVICE_TECHNICIAN")

                        .requestMatchers(HttpMethod.POST, "/api/admin/appointments/check-in").hasRole("STAFF")
                        .requestMatchers("/api/admin/appointments", "/api/admin/appointments/**").hasAnyRole("OPERATIONS_ADMIN", "STAFF")
                        .requestMatchers("/api/admin/booking-restrictions", "/api/admin/booking-restrictions/**").hasRole("OPERATIONS_ADMIN")
                        .requestMatchers("/api/reception/**").hasRole("STAFF")
